...
class CARTGVCriterionTest(unittest.TestCase):
    ...
    def test_init(self):
        ...
        # self.assertEqual(criterion.starts, [start])
        # self.assertEqual(criterion.ends, [end])
...
class CARTGVSplitterTest(unittest.TestCase):
    ...
    def test_one_split(self):
        ...
        clf = DecisionTreeClassifier(max_depth=max_depth, random_state=random_state, max_features=len(groups[0]), max_leaf_nodes=X.shape[0])
        ...
        clf2 = DecisionTreeClassifier(max_depth=max_depth, random_state=random_state, max_features=len(groups[0]), max_leaf_nodes=X.shape[0])
